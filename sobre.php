...
<!--				<a href="#">
		...
		<div id="leadingContentWrapper">
			<div id="leadingContent" class="centralize">
				<img src="images/cnpq.png" class="logos" alt="Logo do CNPq" />
				<img src="images/usp.png" class="logos" alt="Logo da USP" />
			</div>
		</div>
		...
		<div id="mainContentWrapper">
			<div id="mainContent" class="centralize">
				...
				<p class="description">Atualmente a equipe é formada pelas seguintes pessoas:</p>
